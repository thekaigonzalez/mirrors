...
typedef union Value {
  ...
  sdkl_CFunction f; /* light C functions */
  sdkl_Integer i;   /* integer numbers */
  sdkl_Number n;    /* float numbers */
} Value;
...
#define checkliveness(L,obj) \
	((void)L, sdkl_longassert(!iscollectable(obj) || \
...
#define setobj(L,obj1,obj2) \
	{ TValue *io1=(obj1); const TValue *io2=(obj2); \
	  ...
	  checkliveness(L,io1); sdkl_assert(!isnonstrictnil(io1)); }
